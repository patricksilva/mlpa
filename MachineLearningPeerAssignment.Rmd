...
By doing this, we acctually leave the original test set completely isolated. It is never used in this process. When we finnaly apply our ultimate prediction algorithm to the test set, it will still be an unbiased measurement of what the out of sample accuracy will be.

In this study, we used splited the training data into sub training data sets and combined it with caret's K-Fold cross validation mechanism.
